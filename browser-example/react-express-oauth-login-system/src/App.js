...
import LoginSystemHooks from './LoginSystemHooks'
      ...
      <div className="App">
        ...
        <header className="App-header">
           <Router><div style={{width:'70%'}}>
            <PropsRoute path='/' component={LoginSystemHooks}  user={this.state.user} />  
			<Route  exact={true} path='/' component={RedirectToLogin} />
			<PropsRoute path='/login' component={LoginSystem}  {...routeProps}  />
        </div></Router>
        </header>
      </div>
    );

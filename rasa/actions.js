...
const actions = {
	// welcome intent
	action_welcome:function() {return new Promise(function(resolve,reject) {
		resolve({responses:[{text:'Hi, how can I help?'}]}) })},
	...
	action_what_can_i_do:function() {return new Promise(function(resolve,reject) {
	...
	action_navigate_to:function() {return new Promise(function(resolve,reject) {
		resolve({responses:[{text:"I can't do that yet"}]}) })},
